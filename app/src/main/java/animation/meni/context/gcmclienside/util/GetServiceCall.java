...
import animation.meni.context.gcmclienside.app.MyApplication;

public abstract class GetServiceCall implements animation.meni.context.gcmclienside.util.IService {
